...
entry:
  ...
  %call = call noalias ptr @malloc(i64 noundef 1048592) #7
...
if.end:                                           ; preds = %entry
  call void @llvm.memset.p0.i64(ptr align 8 %call, i8 0, i64 1048592, i1 false)
  br label %for.cond
...
for.cond32:                                       ; preds = %for.inc64, %for.end31
  ...
  %cmp34 = icmp sle i64 %conv33, 65536
