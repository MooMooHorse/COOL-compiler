...
@String.0 = local_unnamed_addr constant %String { %_String_vtable* @_String_vtable_prototype, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.0, i32 0, i32 0) }
...
entry:
  ...
  br i1 %vtpm.45.i, label %abort.i, label %Main_new.exit
...
Main_new.exit:                                    ; preds = %entry
  ...
  %vtpm.36.i = tail call %IO* @IO_out_int(%IO* nonnull %vtpm.34.i, i32 7656)
  ret i32 0
}
...
ok.0:
  ...
  %vtpm.36 = tail call %IO* %tmp.0(%IO* nonnull %vtpm.34, i32 7656)
