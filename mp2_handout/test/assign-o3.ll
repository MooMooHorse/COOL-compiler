...
entry:
  %vtpm.4 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([25 x i8], [25 x i8]* @main.printout.str, i64 0, i64 0), i32 5)
  ret i32 0
}
